...
ALTER TABLE detalles_ejercicio
    ADD CONSTRAINT FK_DETALLES_EJERCICIO_ON_ID_RUTINA FOREIGN KEY (id_rutina) REFERENCES ejercicio (id_ejercicio);

ALTER TABLE detalles_ejercicio
    ADD CONSTRAINT FK_DETALLES_EJERCICIO_ON_ID_RUTINAJrMwtt FOREIGN KEY (id_rutina) REFERENCES rutina (id_rutina);